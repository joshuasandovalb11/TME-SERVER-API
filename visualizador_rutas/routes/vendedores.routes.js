// visualizador_rutas/routes/vendedores.routes.js
...
router.get('/vendedores', async (req, res) => {
  console.log('[API] Solicitando lista de vendedores para visualizador_rutas...');
  ...
  try {
    ...
    console.error('❌ Error cargando vendedores visualizador_rutas:', error.message);
